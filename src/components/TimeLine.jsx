    ...
    return (
        <section className='timeline'>
            ...
            <VerticalTimeline>
                ...
                >
                    <h3 className={styles.jobTitle}>Bachelor in Economics</h3>
                ...
                >
                    <h3 className={styles.jobTitle}>International Orientation Leader</h3>
                ...
                >
                    <h3 className={styles.jobTitle}>Academic Peer Advisor</h3>
                    <h4>Santa Barbara, California, USA</h4>
                ...
                >
                    <h3 className={styles.jobTitle}>Master in Economics</h3>
                ...
                >
                    <h3 className={styles.jobTitle}>Institute for Social Research</h3>
                    <h4>Oslo, Norway</h4>
